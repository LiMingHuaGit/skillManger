...
final class NoteStoreTests: XCTestCase {
    ...
    func testArchiveRecoversNotesWhenDefaultsDataIsMissing() throws {
        ...
        environment.defaults.removeObject(forKey: "skillManager.notes.tabs.v1")
        environment.defaults.removeObject(forKey: "skillManager.notes.archive.v2")
        environment.defaults.removeObject(forKey: "skillManager.notes.activeTabID")
