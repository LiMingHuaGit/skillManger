...
struct TabPagerControl: View {
    ...
    var body: some View {
        HStack(alignment: .top, spacing: 6) {
            ...
            if store.canRestoreDeletedNote {
                Button {
                    withAnimation(tabSwitchAnimation) {
                ...
                .buttonStyle(TabIconButtonStyle())
                .fixedSize()
                .help("Restore deleted note")
                .accessibilityLabel("Restore deleted note")
            }
        }
...
struct MarkdownNoteEditor: View {
    ...
    private var configuration: MarkdownEditorConfiguration {
        ...
        let services = MarkdownEditorServices(
            images: imageStore,
            syntaxHighlighter: Self.editorServices.syntaxHighlighter,
            latex: Self.editorServices.latex
        )
