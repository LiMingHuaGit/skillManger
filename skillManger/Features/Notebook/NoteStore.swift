...
final class NoteStore: ObservableObject {
    ...
    private static let legacyTextKey = "skillManager.notes.text"
    private static let tabsKey = "skillManager.notes.tabs.v1"
    private static let archiveDefaultsKey = "skillManager.notes.archive.v2"
    private static let activeTabIDKey = "skillManager.notes.activeTabID"
    private static let lastSavedAtKey = "skillManager.notes.lastSavedAt"
